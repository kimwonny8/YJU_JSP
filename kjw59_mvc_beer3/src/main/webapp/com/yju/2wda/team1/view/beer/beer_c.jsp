...
<form id="createForm" method="post" action="./BeerMultiController.be2" enctype="multipart/form-data">
	...
	<br>맥주사진 : <input type="file" name="b_image2" size="30">
	<br>맥주사진 : <input type="file" name="b_image3" size="30">
